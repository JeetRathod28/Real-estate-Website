...
const NavBar = () => {
    ...
    const handle = () => setShowMobileMenu(prev => !prev)
    ...
    return (
        <div className='absolute top-0 left-0 w-full z-10'>
            <div className=' mx-auto flex justify-between items-center  py-4 px-6 md:px-2 lg:px-32 bg-transparent'>
                ...
                <img src={assets.menu_icon} onClick={handle} className='md:hidden w-7 cursor-pointer' alt="" />
            </div>

            {/* Mobile Menu  */}
            <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>

                <div className='flex justify-end p-6 cursor-pointer' onClick={handle}>
