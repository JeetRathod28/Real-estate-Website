...
const Contact = () => {
    // Web3forms
    const accessKey = import.meta.env.VITE_WEBFORM
    ...
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Ready to Make a Move? Let's Build Future Together</p>
